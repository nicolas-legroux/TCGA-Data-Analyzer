...
vector<double> computePairwisePearsonCorrelation(const vector<vector<double>> &M) {
...
vector<double> computePairwiseSpearmanCorrelation(const vector<vector<double>> &M) {
...
vector<double> computePairwiseEuclideanDistance(
	...
	unsigned int N = M.size();
	cout << endl << "Pairwise euclidean distances to be computed for " << N
			<< " vectors..." << endl;
